<div class="mx-auto max-w-4xl space-y-6" x-data="{ search: '' }">
    @if (session('status'))
    ...
    <!-- Alpine Search Input -->
    <div class="relative bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
    ...
    <form wire:submit="saveSettings" class="space-y-6">
        <div class="space-y-4">
            ...
            <div
                x-show="!search || 'student grading redirect external grading software'.includes(search.toLowerCase())"
                class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800 transition duration-205"
            >
            ...
            <div
                x-show="!search || 'allow student self-registration signup register login page'.includes(search.toLowerCase())"
                class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800 transition duration-205"
            >
            ...
            <div
                x-show="!search || 'enable email notifications system alerts emails'.includes(search.toLowerCase())"
                class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800 transition duration-205"
            >
                <div class="flex items-center justify-between gap-4">
                    <div class="space-y-1">
            ...
            <div
                x-show="!search || 'show detailed bill breakdown student fees payments components'.includes(search.toLowerCase())"
                class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800 transition duration-205"
            >
                <div class="flex items-center justify-between gap-4">
                    <div class="space-y-1">
            ...
            <div
                x-show="!search || 'show attendance policy minimum threshold lectures exam eligibility'.includes(search.toLowerCase())"
                class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800 transition duration-205"
            >
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="space-y-1">
