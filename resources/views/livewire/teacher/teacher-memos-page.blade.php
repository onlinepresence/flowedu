<div class="mx-auto max-w-7xl space-y-6">
    ...
    <div class="grid grid-cols-1 gap-4">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="space-y-1.5 flex-1">
                        ...
                        <h2 class="text-lg font-bold text-gray-900 dark:text-white">
                            <a href="{{ route('teacher.memos.show', $memo->id) }}" wire:navigate class="hover:text-purple-650 dark:hover:text-purple-400 transition">
                                {{ $memo->title }}
                            </a>
                        </h2>
                    ...
                    <div class="flex items-center justify-between sm:justify-end gap-4 shrink-0">
                        ...
                        <a
                            href="{{ route('teacher.memos.show', $memo->id) }}"
                            wire:navigate
        ...
        @empty
            <div class="bg-white shadow-sm rounded-lg border border-gray-200 dark:border-gray-700 dark:bg-gray-800 p-8 text-center">
                <i class="fa-solid fa-envelope-open text-4xl text-gray-300 dark:text-gray-600 block mb-2"></i>
                <p class="text-sm font-medium text-gray-900 dark:text-white">{{ __('No memos found') }}</p>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ __('Try searching or matching other filter configurations.') }}</p>
            </div>
        @endforelse
    </div>
