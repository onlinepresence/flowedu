<div class="mx-auto max-w-7xl space-y-6">
    <div>
        <a href="{{ route('student.memos.index') }}" wire:navigate class="inline-flex items-center gap-1.5 text-sm font-semibold text-purple-600 hover:text-purple-500 dark:text-purple-400 dark:hover:text-purple-300">
