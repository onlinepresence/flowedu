...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .ps-dl dt { margin: 0; color: var(--ps-muted); font-weight: 500; }
        .ps-dl dd { margin: 0; font-weight: 600; }
        @media (max-width: 480px) {
            .ps-dl { grid-template-columns: 1fr; }
        }
        ...
        .ps-card .ps-dl { font-size: 0.875rem; }
        .ps-table {
            width: 100%;
        ...
        @media print {
            ...
            .print-shell { max-width: none; padding: 0; margin: 0; }
            .ps-card {
...
<body>
    <div class="no-print print-toolbar">
        <a href="{{ $backUrl ?? url('/admin/students') }}">← {{ __('Back') }}</a>
