...
class TeacherMemosPage extends Component
{
    use WithPagination;
    ...
    public function render(): View
    {
        ...
        return view('livewire.teacher.teacher-memos-page', [
            'memos' => $memos,
        ])->layout('components.layouts.teacher', [
            'title' => __('Memos & Announcements'),
            'headerDescription' => __('Official communications dispatched to you.'),
        ]);
    }
}
