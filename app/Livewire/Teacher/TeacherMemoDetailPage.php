...
class TeacherMemoDetailPage extends Component
{
    public Memo $memo;
    ...
    public function acknowledgeMemo(): void
    {
        ...
        $this->redirect(route('teacher.memos.show', $this->memo->id), navigate: true);
    }
    ...
    {
        return view('livewire.teacher.teacher-memo-detail-page')
            ->layout('components.layouts.teacher', ['title' => __('Memo Details')]);
    }
}
