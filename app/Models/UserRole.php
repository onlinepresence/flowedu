    ...
    public static function ensureSystemRoles(): void
    {
        $roles = [
            ...
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'student_management', 'approve_registrations', 'view_profile',
            ...
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'course_management', 'teacher_management', 'view_profile',
            ...
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'student_management', 'teacher_management', 'course_management',
                    'view_financial_data', 'approve_registrations', 'view_profile', 'nav_dashboard',
                    ...
                    'nav_staff_non_teaching', 'nav_staff_assignments', 'nav_staff_roles', 'nav_teachers_list',
                    'nav_teachers_assignments', 'nav_teachers_roles', 'nav_teachers_evaluations', 'nav_teachers_materials',
                    'nav_teachers_announcements', 'nav_finance_fees', 'nav_finance_payments', 'nav_finance_outstanding',
            ...
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'student_management', 'teacher_management', 'course_management',
                    'approve_registrations', 'view_profile', 'nav_dashboard', 'nav_students_index',
            ...
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'view_financial_data', 'view_profile', 'nav_dashboard',
                    'nav_finance_fees', 'nav_finance_payments', 'nav_finance_outstanding', 'nav_finance_scholarships',
                    'nav_reports_payments', 'nav_memos', 'create_memo', 'forward_memo'
                ],
            ],
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'student_management', 'view_profile', 'nav_dashboard',
            ...
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'view_profile', 'nav_dashboard', 'nav_memos', 'create_memo', 'forward_memo'
                ],
            ],
            [
            ...
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'approve_registrations', 'view_profile', 'nav_dashboard', 'nav_students_index', 'nav_memos', 'create_memo'
                ],
            ],
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'view_profile', 'nav_dashboard', 'nav_grading_points', 'nav_grading_enter', 'nav_grading_upload', 'nav_grading_approve', 'nav_grading_transcripts', 'nav_memos', 'create_memo'
                ],
            ],
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'view_profile', 'nav_dashboard', 'nav_teachers_evaluations', 'nav_teachers_materials', 'nav_memos', 'create_memo'
                ],
            ],
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'teacher_management', 'view_profile', 'nav_dashboard', 'nav_staff_home', 'nav_staff_non_teaching', 'nav_staff_assignments', 'nav_staff_roles', 'nav_teachers_list', 'nav_teachers_assignments', 'nav_teachers_roles', 'nav_memos', 'create_memo'
                ],
            ],
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'view_financial_data', 'view_profile', 'nav_dashboard', 'nav_finance_fees', 'nav_finance_payments', 'nav_finance_outstanding', 'nav_finance_scholarships', 'nav_memos', 'create_memo'
                ],
            ],
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'view_profile', 'nav_dashboard', 'nav_teachers_announcements', 'nav_memos', 'create_memo'
                ],
            ],
            [
                ...
                'permissions' => [
                    'view_dashboard_admin', 'view_profile', 'nav_dashboard', 'nav_memos', 'create_memo'
                ],
            ],
        ];
        ...
        foreach ($roles as $row) {
            ...
            $role->permissions = array_values(array_unique(array_merge($existing, $row['permissions'])));
            $role->save();
        }
    }
}
