    ...
    'admin' => [
        ...
        'main' => [
            ...
            [
                ...
                'icon' => 'users',
                'children' => [
                    ['label' => 'All Lecturers', 'route' => 'admin.staff.teachers', 'permission' => 'nav_teachers_list'],
                    ['label' => 'Lecturer Assignments', 'route' => 'admin.staff.teacher-assignments', 'permission' => 'nav_teachers_assignments'],
                    ['label' => 'Lecturer Roles', 'route' => 'admin.staff.teacher-roles', 'permission' => 'nav_teachers_roles'],
                    ['label' => 'Lecturer Evaluations', 'route' => 'admin.evaluations', 'permission' => 'nav_teachers_evaluations'],
                    ['label' => 'Course Materials Review', 'route' => 'admin.staff.materials', 'permission' => 'nav_teachers_materials'],
                    ['label' => 'Lecturer Announcements', 'route' => 'admin.staff.announcements', 'permission' => 'nav_teachers_announcements'],
